...
class R3Pty(val name: X500Name, settings: SettingsProvider, dimension: Dimension, val onExit: () -> Unit) : AutoCloseable {
    ...
    private fun createTtyConnector(command: Array<String>, environment: Map<String, String>, workingDir: String?): PtyProcessTtyConnector {
        ...
        try {
            return PtyProcessTtyConnector(name.toString(), process, UTF_8)
        } catch (e: Exception) {
