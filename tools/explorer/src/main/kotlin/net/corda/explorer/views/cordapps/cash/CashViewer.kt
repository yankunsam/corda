...
class CashViewer : CordaView("Cash") {
    ...
    inner class StateRowGraphic(val stateRow: StateRow) : UIComponent() {
        ...
        init {
            ...
            issuerValueLabel.textProperty().bind(SimpleStringProperty(resolvedIssuer.nameOrNull()?.commonName ?: "Anonymous"))
    ...
    init {
        ...
        cashViewerTableIssuerCurrency.setCellValueFactory {
            ...
            when (node) {
            // TODO: Anonymous should probably be italicised or similar
                is ViewerNode.IssuerNode -> SimpleStringProperty(node.issuer.nameOrNull()?.commonName ?: "Anonymous")
