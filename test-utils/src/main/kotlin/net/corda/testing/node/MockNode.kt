...
class MockNetwork(private val networkSendManuallyPumped: Boolean = false,
    ...
    fun createNode(networkMapAddress: SingleMessageRecipient? = null, forcedID: Int = -1, nodeFactory: Factory = defaultFactory,
        ...
        val config = TestNodeConfiguration(
                baseDirectory = path,
                myLegalName = legalName ?: X509Utilities.getDevX509Name("Mock Company $id"),
                networkMapService = null,
                dataSourceProperties = makeTestDataSourceProperties(X509Utilities.getDevX509Name("node_${id}_net_$networkId")))
