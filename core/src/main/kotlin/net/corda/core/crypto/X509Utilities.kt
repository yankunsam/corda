...
object X509Utilities {
    ...
    fun createCAKeyStoreAndTrustStore(keyStoreFilePath: Path,
        ...
        val rootCA = createSelfSignedCACert(X500Name("CN=Corda Node Root CA,O=R3,OU=corda,L=London,C=UK"))
        val intermediateCA = createIntermediateCert(X500Name("CN=Corda Node Intermediate CA,O=R3,OU=corda,L=London,C=UK"), rootCA)
