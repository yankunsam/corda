...
val DUMMY_NOTARY_KEY: KeyPair by lazy { entropyToEdDSAKeyPair(BigInteger.valueOf(20)) }
/** Dummy notary identity for tests and simulations */
val DUMMY_NOTARY: Party get() = Party("Notary Service", DUMMY_NOTARY_KEY.public)

val DUMMY_MAP_KEY: KeyPair by lazy { entropyToEdDSAKeyPair(BigInteger.valueOf(30)) }
...
val DUMMY_BANK_A_KEY: KeyPair by lazy { entropyToEdDSAKeyPair(BigInteger.valueOf(40)) }
/** Dummy bank identity for tests and simulations */
val DUMMY_BANK_A: Party get() = Party("Bank A", DUMMY_BANK_A_KEY.public)

val DUMMY_BANK_B_KEY: KeyPair by lazy { entropyToEdDSAKeyPair(BigInteger.valueOf(50)) }
/** Dummy bank identity for tests and simulations */
val DUMMY_BANK_B: Party get() = Party("Bank B", DUMMY_BANK_B_KEY.public)

val DUMMY_BANK_C_KEY: KeyPair by lazy { entropyToEdDSAKeyPair(BigInteger.valueOf(60)) }
/** Dummy bank identity for tests and simulations */
val DUMMY_BANK_C: Party get() = Party("Bank C", DUMMY_BANK_C_KEY.public)



val ALICE_KEY: KeyPair by lazy { entropyToEdDSAKeyPair(BigInteger.valueOf(70)) }
/** Dummy individual identity for tests and simulations */
val ALICE: Party get() = Party("Alice", ALICE_KEY.public)

val BOB_KEY: KeyPair by lazy { entropyToEdDSAKeyPair(BigInteger.valueOf(80)) }
/** Dummy individual identity for tests and simulations */
val BOB: Party get() = Party("Bob", BOB_KEY.public)

val CHARLIE_KEY: KeyPair by lazy { entropyToEdDSAKeyPair(BigInteger.valueOf(90)) }
/** Dummy individual identity for tests and simulations */
